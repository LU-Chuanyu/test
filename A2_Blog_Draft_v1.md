...
There's irony in where the cilantro number came from. That 8.7%, the figure that quietly deflates the whole gene-versus-tongue drama, sits inside a paper [2] published by 23andMe — a company whose business model rests on the opposite implication: that the answer to *why are you the way you are* is in your saliva, waiting to be unsealed for a hundred dollars. The number is in their own study, but it has never been the number on the marketing page. What travels instead is the headline-friendly half of the same paper — *there is a "cilantro gene"* — recycled into listicles, ad copy and kit inserts, while the 8.7% stays buried in the methods. The cilantro literature, in other words, has been mined for the part that sells subscriptions and stripped of the part that would unsell them. Read end-to-end, the company's own science says the genome's share of the argument rounds to *not very much*; read the way the industry has spent fifteen years quoting it, the genome is the argument.
