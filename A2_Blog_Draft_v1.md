...
Read on its own, each of those sources has a ceiling worth naming. Mauer and El-Sohemy's percentages come from a single Toronto sample of young adults answering a one-shot online survey rather than tasting anything, and because their ethnocultural categories partly track genetic ancestry, the cultural gradient may quietly absorb some of the very genetic signal it appears to dwarf [4]. The 2025 recipe-database study widens the frame and confirms that flavour profiles are deeply local and can shift within a single generation [5] — yet recipes describe what kitchens *cook*, not what individual mouths *enjoy*; they are a strong proxy for shared culinary habit and a noisier one for personal preference. And mere-exposure has mostly been demonstrated on milder flavours [6], so whether enough taco nights can fully override a strong, chemically driven soapy percept remains, as Spence concedes, largely anecdotal [1]. Stacked together, though, those limitations cut the same way: no single study *proves* cilantro liking is learned, but each closes a different escape route for a purely genetic explanation. Culture clearly bends the verdict; *how far* it can bend it is the genuinely open question.
