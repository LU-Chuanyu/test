...
The cultural account has its own ceiling, though, and it is worth naming. Mauer and El-Sohemy's percentages come from a single Toronto sample of young adults answering a one-shot online survey rather than tasting anything, and their ethnocultural categories partly track genetic ancestry, so the cultural gradient may quietly absorb some of the very genetic signal it appears to dwarf [4]. The 2025 recipe-database study reaches further geographically [5], but it measures what cultures *cook*, not what individual mouths *enjoy*. And the mere-exposure literature is built mostly on milder flavours [6], so whether enough taco nights can fully overwrite a strong, chemically driven soapy sensation remains, as Spence concedes, mostly anecdotal [1]. Culture clearly bends the verdict — *how far* it can bend it is the genuinely open question.
